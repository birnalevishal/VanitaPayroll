...
{
    public partial class SalaryIncrementProcessing : System.Web.UI.Page
    {
        ...
        protected void salaryProcess(string month, string year, string empCode, string opr)
        {
            ...
            try
            {
                ...
                strQry = " select * from udfIncMonthlysalary(" + Convert.ToInt16(Session["OrgID"]) + ",'" + Convert.ToDateTime(dt).ToString("dd MMM yyyy") + "','" + ddlMon.SelectedValue + ddlYear.SelectedValue + "','" + ddlYear.SelectedValue + ddlMon.SelectedValue + "'," + workingDays + "," + actualWorkingDays + ")";
                if (opr == "1")
                {
                ...
                strQry += " dbo.M_Emp.Employeename, dbo.M_Emp.Birthdate, dbo.M_Emp.Gendercd, dbo.M_Emp.WStatecd, dbo.M_Emp.PFApplicable,dbo.M_Emp.PFJoindate, dbo.M_Emp.ProfTaxApplicable, dbo.M_Emp.LabWelApplicable, dbo.M_Emp.ESIApplicable, dbo.M_Emp.ESICalculate, dbo.M_Emp.OrigJoindate,";
                ...
                if (objDT.Rows.Count > 0)
                {
                            ...
                            if ((Convert.ToInt16(ddlMon.SelectedValue)>=Convert.ToInt16(wefMonth)) && (Convert.ToInt16(ddlYear.SelectedValue) >= Convert.ToInt16(wefYear)))
                            {
                                ...
                                if (objDT.Rows[i]["empDesignation"].ToString() == "21")
                                {
                                    ...
                                    if (objDTHamaliSal.Rows.Count > 0)
                                    {
                                        for (int j = 0; j < objDTHamaliSal.Rows.Count; j++)
                                        {
                                            ...
                                            //Total Hamali Greater than Standard Gross
                                            if (Convert.ToDouble(objDTHamaliSal.Rows[j]["TotalHamali"]) == 0)
                                            {
                                                //Attendance
                                                dr["daysInMonth"] = daysInMonth;
                                                if (objDT.Rows[i]["Weeklyoff"] != DBNull.Value)
                                            ...
                                            else if (Convert.ToDouble(objDTHamaliSal.Rows[j]["TotalHamali"]) > Convert.ToDouble(objDTHamaliSal.Rows[j]["Gross"]))
                                            {
                                                ...
                                                dr["Canteen"] = stadCanteen;
                                                basicForEsi = basicForEsi + stadCanteen;
                                                ...
                                                {
                                                    dr["Ded1"] = Convert.ToDouble(objDT.Rows[i]["Ded1"]);
                                                    deduction = deduction + Convert.ToDouble(objDT.Rows[i]["Ded1"]);
                                                }
                                                #endregion
                                            ...
                                            else
                                            {
                                                ...
                                                #region[Earning]
                                                stadGross = Convert.ToDouble(objDTHamaliSal.Rows[j]["Gross"]);

                                                oneDaySal = Convert.ToDouble(objDTHamaliSal.Rows[j]["Gross"]) / workingDays;

                                                presentDays = Convert.ToDouble(objDTHamaliSal.Rows[j]["TotalHamali"]) / oneDaySal;
                                                ...
                                                while (grossSalary != Convert.ToDouble(objDTHamaliSal.Rows[j]["TotalHamali"]))
                                                {
                                                    ...
                                                    if (grossSalary != Convert.ToDouble(objDTHamaliSal.Rows[j]["TotalHamali"]))
                                                    {
                                                        if (Convert.ToDouble(objDTHamaliSal.Rows[j]["TotalHamali"]) - grossSalary >= 70)
                                                        {
                                                            insentive = Convert.ToDouble(objDTHamaliSal.Rows[j]["TotalHamali"]) - grossSalary;
                                                        }
                                                        else
                                                        {
                                                            presentDays -= 0.50;
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        grossSalary = grossSalary + stadCanteen;
                                        dr["Canteen"] = stadCanteen;
                                        basicForEsi = basicForEsi + Math.Round(Convert.ToDouble(objDT.Rows[i]["Canteen"]));
                                        ...
                                        grossSalary = grossSalary + stadUniform;
                                        dr["Uniform"] = stadUniform;
                                        basicForEsi = basicForEsi + Math.Round(Convert.ToDouble(objDT.Rows[i]["Uniform"]));

                                        add1 = Math.Round(Convert.ToDouble(objDT.Rows[i]["Add1"]));
                                        grossSalary = grossSalary + add1;
                                        dr["Add1"] = add1;
                                        basicForEsi = basicForEsi + Math.Round(Convert.ToDouble(objDT.Rows[i]["Add1"]));
                                        ...
                                        if (objDT.Rows[i]["Advance"] != DBNull.Value)
                                        {
                                            dr["salaryAdvance"] = Convert.ToDouble(objDT.Rows[i]["Advance"]);
                                            deduction = deduction + Convert.ToDouble(objDT.Rows[i]["Advance"]);
                                            deductionImp = Convert.ToDouble(objDT.Rows[i]["Advance"]);
                                        }
                                        if (objDT.Rows[i]["Loan"] != DBNull.Value)
                                        {
                                            dr["Loan"] = Convert.ToDouble(objDT.Rows[i]["Loan"]);
                                            deduction = deduction + Convert.ToDouble(objDT.Rows[i]["Loan"]);
                                            deductionImp += Convert.ToDouble(objDT.Rows[i]["Loan"]);
                                        }
                                        if (objDT.Rows[i]["TDS"] != DBNull.Value)
                                        {
                                            dr["TDS"] = Convert.ToDouble(objDT.Rows[i]["TDS"]);
                                            deduction = deduction + Convert.ToDouble(objDT.Rows[i]["TDS"]);
                                            deductionImp += Convert.ToDouble(objDT.Rows[i]["TDS"]);
                                        }
                                        if (objDT.Rows[i]["TardalPathsansth"] != DBNull.Value)
                                        {
                                            dr["TardalPathsansth"] = Convert.ToDouble(objDT.Rows[i]["TardalPathsansth"]);
                                            deduction = deduction + Convert.ToDouble(objDT.Rows[i]["TardalPathsansth"]);
                                            deductionImp += Convert.ToDouble(objDT.Rows[i]["TardalPathsansth"]);
                                        }
                                        if (objDT.Rows[i]["Ded1"] != DBNull.Value)
                                        {
                                            dr["Ded1"] = Convert.ToDouble(objDT.Rows[i]["Ded1"]);
                    ...
                    if (opr == "2")
                    {
                        ...
                        {
                            strQrySalary = "delete from T_SalaryIncrement where OrgId=@OrgID and MonYrcd=@MonYrcd";
                            ...
                            for (int i = 0; i < dtEmpSalary.Rows.Count; i++)
                            {
                                ...
                                strQrySalary = @"INSERT INTO T_SalaryIncrement(OrgId, MonYrcd, Docdate,Employeecd,MonthDay,PayDay,AbsentDay,PL,PresentDay,Weeklyoff,Holiday,Coff,PayableDay,
