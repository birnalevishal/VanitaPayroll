<%@ Page Title="Import Excel For Gratuity" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GratuityImpExcel.aspx.cs" Inherits="PayRoll.Masters.GratuityImpExcel" %>
                    ...
                    <div class="panel-body">
                        <div id="hbreadcrumb" class="pull-right">
                            <ol class="hbreadcrumb breadcrumb">
                                ...
                                <li class="active">
                                    <span>Import Excel For Gratuity </span>
                                </li>
                            </ol>
                        </div>
                        <h2 class="font-light m-b-xs">Import Excel For Gratuity
                        </h2>
                    </div>
                </div>
            </div>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group col-lg-3" style="padding-top:10px; float:right">
                                        <a href="DownloadFile.ashx?file=~/ImportFormatFiles/GratuityImportFormat.xlsx" class="btn btn-outline btn-warning" TabIndex="6">Download Import Format</a>
                                    </div>
                                </div>
                                <div class="col-lg-12">
