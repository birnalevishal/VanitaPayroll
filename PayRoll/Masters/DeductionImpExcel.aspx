<%@ Page Title="Import Excel For Deduction" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DeductionImpExcel.aspx.cs" Inherits="PayRoll.Masters.DeductionImpExcel" %>
                    ...
                    <div class="panel-body">
                        <div id="hbreadcrumb" class="pull-right">
                            <ol class="hbreadcrumb breadcrumb">
                                ...
                                <li class="active">
                                    <span>Import Excel For Deduction </span>
                                </li>
                            </ol>
                        </div>
                        <h2 class="font-light m-b-xs">Import Excel For Deduction
                        </h2>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="hpanel hblue">
                            <div class="panel-heading hbuilt">
                                ...
                                Import Excel For Deduction
                            </div>
                            <div class="panel-body">
                                <div class="col-lg-12">
                                    <div class="form-group col-lg-3">
                                        <label for="username">Month Name</label>
                                        <asp:DropDownList ID="ddlMon" runat="server" AutoPostBack="true" class="form-control" name="account" TabIndex="1" OnSelectedIndexChanged="ddlMon_SelectedIndexChanged">
                                    ...
                                    <div class="form-group col-lg-3">
                                        ...
                                        <asp:DropDownList ID="ddlYear" runat="server" AutoPostBack="true" class="form-control" name="account"  TabIndex="2" OnSelectedIndexChanged="ddlYear_SelectedIndexChanged"></asp:DropDownList>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group col-lg-3" style="padding-top:10px; float:right">
                                        <a href="DownloadFile.ashx?file=~/ImportFormatFiles/DeductionImportFormat.xlsx" class="btn btn-outline btn-warning" TabIndex="6">Download Import Format</a>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                         ...
                                         <div class="col-lg-4">
                                            <div class="hpanel">
                                                <div class="panel-heading">
                                                    ...
                                                    <asp:Label ID="lblDedHeading" runat="server" Text="Deduction Not Found List" Font-Bold="true"></asp:Label>
                                                </div>
                                                <div class="panel-body">
                                                    <asp:GridView ID="gvDeduction" runat="server" class="table table-striped table-bordered table-hover" AllowPaging="True" AutoGenerateColumns="False" PageSize="20" Width="100%" DataKeyNames="Employeecd">
                                                        <Columns>
