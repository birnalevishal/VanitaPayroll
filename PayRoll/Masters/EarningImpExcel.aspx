<%@ Page Title="Earnings Import" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EarningImpExcel.aspx.cs" Inherits="PayRoll.Masters.EarningImpExcel" %>
                    ...
                    <div class="panel-body">
                        <div id="hbreadcrumb" class="pull-right">
                            <ol class="hbreadcrumb breadcrumb">
                                ...
                                <li class="active">
                                    <span>Import Excel For Earnings </span>
                                </li>
                            </ol>
                        </div>
                        <h2 class="font-light m-b-xs">Import Excel For Earnings
                        </h2>
                    </div>
                </div>
            </div>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group col-lg-3" style="padding-top:10px; float:right">
                                        <a href="DownloadFile.ashx?file=~/ImportFormatFiles/EarningImportFormat.xlsx" class="btn btn-outline btn-warning" TabIndex="6">Download Import Format</a>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                         ...
                                         <div class="col-lg-4">
                                            <div class="hpanel">
                                                <div class="panel-heading">
                                                    ...
                                                    <asp:Label ID="lblEarHeading" runat="server" Text="Earning Not Found List" Font-Bold="true"></asp:Label>
                                                </div>
                                                <div class="panel-body">
                                                    <asp:GridView ID="gvEarning" runat="server" class="table table-striped table-bordered table-hover" AllowPaging="True" AutoGenerateColumns="False" PageSize="20" Width="100%" DataKeyNames="Employeecd">
                                                        <Columns>
