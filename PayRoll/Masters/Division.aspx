<%@ Page Title="Division Master" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Division.aspx.cs" Inherits="PayRoll.Masters.Division" %>
            ...
            <div class="small-header">
                <div class="hpanel">
                    <div class="panel-body">
                        ...
                        <h2 class="font-light m-b-xs">Division Master
                        </h2>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="hpanel hblue">
                            <div class="panel-heading hbuilt">
                                ...
                                Add/Edit Division Name
                            </div>
                            <div class="panel-body">
                                <div class="form-group">
                                    <label for="username">Division Name</label>
                                    <asp:TextBox ID="txtName" runat="server" type="text" placeholder="Enter Division Name" MaxLength="50" class="form-control" name="name"  ValidationGroup="OK" TabIndex="1" onkeypress="return onlyAlphabets(event,this);"></asp:TextBox>
                    ...
                    <div class="col-lg-6">
                        <div class="hpanel hblue">
                            ...
                            <div class="panel-body">
                                <asp:GridView ID="gvList" runat="server" class="table table-striped table-bordered table-hover" AllowPaging="True" AutoGenerateColumns="False" PageSize="10" Width="100%" OnPageIndexChanging="gvList_PageIndexChanging" OnRowCommand="gvList_RowCommand">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Division" HeaderText="Division Name" HeaderStyle-CssClass="col-lg-4" />
