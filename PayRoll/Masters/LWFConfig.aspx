<%@ Page Title="Labour Welfare Fund Master" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LWFConfig.aspx.cs" Inherits="PayRoll.Masters.LWFConfig" %>
            ...
            <div class="small-header">
                <div class="hpanel">
                    <div class="panel-body">
                        ...
                        <h2 class="font-light m-b-xs">Labour Welfare Fund Master
                        </h2>
                    ...
                    <div class="col-lg-6">
                         <div class="hpanel hblue">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group col-lg-6">
                                        <label for="username">LWF Employee Contribution </label>
                                        <asp:TextBox ID="Lwf" runat="server" type="text" placeholder="Enter LWF Emp" class="form-control" name="name"   ValidationGroup="OK" TabIndex="3" onkeypress="return onlyNumbers(event,this);" MaxLength="6"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Lwf" ErrorMessage="Lwf Is Required" Display="Dynamic" ForeColor="Red" ValidationGroup="OK"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="form-group col-lg-6">
                                        <label for="username">LWF Company Contribution </label>
                                        <asp:TextBox ID="txtLWFComp" runat="server" type="text" placeholder="Enter LWF Company" class="form-control" name="name"   ValidationGroup="OK" TabIndex="3" onkeypress="return onlyNumbers(event,this);" MaxLength="6"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RFVtxtLWFComp" runat="server" ControlToValidate="txtLWFComp" ErrorMessage="Lwf Is Required" Display="Dynamic" ForeColor="Red" ValidationGroup="OK"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                            ...
                            <div class="panel-body">
                                <asp:GridView ID="gvList" runat="server" class="table table-striped table-bordered table-hover" AllowPaging="True" AutoGenerateColumns="False" PageSize="5" Width="100%" DataKeyNames="OrgId" OnPageIndexChanging="gvList_PageIndexChanging" OnRowCommand="gvList_RowCommand">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Lwf" HeaderText="LWF Employee" HeaderStyle-CssClass="col-lg-4">
                                            <HeaderStyle CssClass="col-lg-1" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="LWFCompContri" HeaderText="LWF Company" HeaderStyle-CssClass="col-lg-4">
                                            <HeaderStyle CssClass="col-lg-1" />
                                        </asp:BoundField>
