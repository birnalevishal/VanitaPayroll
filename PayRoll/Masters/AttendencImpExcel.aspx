<%@ Page Title="Attendance Import" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AttendencImpExcel.aspx.cs" Inherits="PayRoll.Masters.AttendencImpExcel" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <script type = "text/javascript">
        ...
        function Confirm() {
            ...
            if (confirm("Attendance Already Imported. Do You Want To Reimport?")) {
                    ...
                    <div class="panel-body">
                        <div id="hbreadcrumb" class="pull-right">
                            <ol class="hbreadcrumb breadcrumb">
                                ...
                                <li class="active">
                                    <span>Import Excel For Attendance </span>
                                </li>
                            </ol>
                        </div>
                        <h2 class="font-light m-b-xs">Import Excel For Attendance
                        </h2>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="hpanel hblue">
                            <div class="panel-heading hbuilt">
                                ...
                                Import Excel For Attendance
                            </div>
                            <div class="panel-body">
                                <div class="col-lg-12">
                                    <div class="form-group col-lg-3">
                                        <label for="username">Month Name</label>
                                        <asp:DropDownList ID="ddlMon" runat="server" class="form-control" name="account" CausesValidation="True" TabIndex="1" AutoPostBack="true" OnSelectedIndexChanged="ddlMon_SelectedIndexChanged">
                                    ...
                                    <div class="form-group col-lg-3">
                                        ...
                                        <asp:DropDownList ID="ddlYear" runat="server" class="form-control" name="account" CausesValidation="True" TabIndex="2" AutoPostBack="true" OnSelectedIndexChanged="ddlYear_SelectedIndexChanged"></asp:DropDownList>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group col-lg-6">
                                        <asp:Label ID="lblMsg" runat="server" Text="" Font-Size="Medium" Font-Bold="true" ForeColor="Red"></asp:Label>
                                    </div>

                                    <div class="form-group col-lg-3" style="padding-top:10px; float:right">
                                        <a href="DownloadFile.ashx?file=~/ImportFormatFiles/AttendanceImportFormat.xlsx" class="btn btn-outline btn-warning" TabIndex="6">Download Import Format</a>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="hpanel">
                                                ...
                                                <div class="panel-body">
                                                    <asp:GridView ID="gvAttendence" runat="server" class="table table-striped table-bordered table-hover" AllowPaging="True" AutoGenerateColumns="False" PageSize="20" Width="100%" DataKeyNames="Employeecd" OnSelectedIndexChanged="gvAttendence_SelectedIndexChanged">
                                                        <Columns>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="hpanel">
                                                ...
                                                <div class="panel-body">
                                                    <asp:GridView ID="gvConfiguration" runat="server" class="table table-striped table-bordered table-hover" AllowPaging="True" AutoGenerateColumns="False" PageSize="20" Width="100%" DataKeyNames="Employeecd">
                                                        <Columns>
                                                            <asp:BoundField DataField="Employeecd" HeaderText="Employee Code" HeaderStyle-CssClass="col-lg-6">
                                                                <HeaderStyle CssClass="col-lg-2"></HeaderStyle>
                                                            </asp:BoundField>
                                        ...
                                        <div  class="col-lg-6">
                                            <div class="panel-heading">
                                                    ...
                                                    Employee Allowance Configuration Not Found/Approved 
                                                </div>
                                            <div class="panel-body">
                                                    <asp:GridView ID="gvAllowance" runat="server" class="table table-striped table-bordered table-hover" AllowPaging="True" AutoGenerateColumns="False" PageSize="20" Width="100%" DataKeyNames="Employeecd">
                                                        <Columns>
                                                            <asp:BoundField DataField="Employeecd" HeaderText="Employee Code" HeaderStyle-CssClass="col-lg-6">
                                                                <HeaderStyle CssClass="col-lg-2"></HeaderStyle>
                                                            </asp:BoundField>
                                                            ...
                                                            <asp:BoundField DataField="Attendence" HeaderText="Allow. Config." HeaderStyle-CssClass="col-lg-4">
                                                                <HeaderStyle CssClass="col-lg-4"></HeaderStyle>
                                                            </asp:BoundField>
