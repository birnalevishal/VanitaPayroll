<%@ Page Title="Head Quarter Master" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HQ.aspx.cs" Inherits="PayRoll.Masters.HQ" %>
            ...
            <div class="small-header">
                <div class="hpanel">
                    <div class="panel-body">
                        ...
                        <h2 class="font-light m-b-xs">Head Quarter Master
                        </h2>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="hpanel hblue">
                            <div class="panel-heading hbuilt">
                                ...
                                Add/Edit Head Quarter Name
                            </div>

                            <div class="panel-body">

                                <div class="form-group">
                                    <label for="username">Head Quarter Name</label>
                                    <asp:TextBox ID="txtName" runat="server" type="text" placeholder="Enter Head Quarter Name" class="form-control" MaxLength="25" Pattern="[a-zA-Z ]+" name="name"  ValidationGroup="OK" TabIndex="1" onkeypress="return onlyAlphabets(event,this);"></asp:TextBox>
                    ...
                    <div class="col-lg-6">
                        <div class="hpanel hblue">
                            ...
                            <div class="panel-body">
                                <asp:GridView ID="gvHQList" runat="server" class="table table-striped table-bordered table-hover" AllowPaging="True" AutoGenerateColumns="False" PageSize="5" Width="100%" DataKeyNames="HQId" OnRowCommand="gvCountryList_RowCommand" OnPageIndexChanging="gvCountryList_PageIndexChanging">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="HQName" HeaderText="Head Quarter Name" HeaderStyle-CssClass="col-lg-6">
