...
{
    public partial class PfECREmployeerRegister : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dsRegister.udf_EmployeerPFECRDataTable dt1 = new dsRegister.udf_EmployeerPFECRDataTable();

                dsRegisterTableAdapters.udf_EmployeerPFECRTableAdapter dt = new dsRegisterTableAdapters.udf_EmployeerPFECRTableAdapter();
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/rptPFECEmployeeRegister.rdlc");
            ...
            try
            {
                ...
                if(dt3.Rows.Count>0)
                {
                    for(int i=0;i<dt3.Rows.Count;i++)
                    {
                        ...
                        strcsv += Convert.ToInt64(dt3.Rows[i]["Present"]).ToString("0") ;
                    ...
                    string fileName = Server.MapPath("~/CSV/") + Path.GetFileName(ddlMon.SelectedValue + ddlYear.SelectedValue +"_Employeer"+ ".txt");
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=" + ddlMon.SelectedValue + ddlYear.SelectedValue + "_Employeer" + ".txt");
                    Response.Charset = "";
