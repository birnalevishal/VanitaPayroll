<%@ Page Title="Leave Balance Register" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LeaveBalanceRegister.aspx.cs" Inherits="PayRoll.Reports.LeaveBalanceRegister" %>
                    ...
                    <div class="panel-body">
                        <div id="hbreadcrumb" class="pull-right">
                            <ol class="hbreadcrumb breadcrumb">
                                ...
                                <li class="active">
                                    <span>Leave Balance Register </span>
                                </li>
                            </ol>
                        </div>
                        <h2 class="font-light m-b-xs">Leave Balance Register Report
                        </h2>
