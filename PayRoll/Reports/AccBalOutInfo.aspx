<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AccBalOutInfo.aspx.cs" Inherits="PayRoll.Reports.AccBalOutInfo" %>
                    ...
                    <div class="panel-body">
                        <div id="hbreadcrumb" class="pull-right">
                            <ol class="hbreadcrumb breadcrumb">
                                ...
                                <li class="active">
                                    <span>Account Balance Outstanding Information </span>
                                </li>
                            </ol>
                        </div>
                        <h2 class="font-light m-b-xs">Account Balance Outstanding Information
                        </h2>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="panel-heading hbuilt">
                                ...
                                Account Balance Outstanding Information
                            </div>
                            <div class="panel-body">
