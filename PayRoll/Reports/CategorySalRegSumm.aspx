<%@ Page Title="Category Wise Salary Reg. Summary" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CategorySalRegSumm.aspx.cs" Inherits="PayRoll.Reports.CategorySalRegSumm" %>
                    ...
                    <div class="panel-body">
                        <div id="hbreadcrumb" class="pull-right">
                            <ol class="hbreadcrumb breadcrumb">
                                ...
                                <li class="active">
                                    <span>Category Wise Salary Reg. Summary </span>
                                </li>
                            </ol>
                        </div>
                        <h2 class="font-light m-b-xs">Category Wise Salary Reg. Summary
                        </h2>
            ...
            <div class="content">
                <div class="row">
                     ...
                     <div class="hpanel hblue">
                            ...
                            Category Wise Salary Register Summary
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group col-lg-2">
                                    ...
                                    <asp:DropDownList ID="ddlCategory" runat="server" class="form-control" name="account" CausesValidation="True" TabIndex="3">
                                    </asp:DropDownList>
                                </div>
                            </div>
