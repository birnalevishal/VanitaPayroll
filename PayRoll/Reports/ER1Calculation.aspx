<%@ Page Title="ER1 Calculation Report" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ER1Calculation.aspx.cs" Inherits="PayRoll.Reports.ER1Calculation" %>
                    ...
                    <div class="panel-body">
                        <div id="hbreadcrumb" class="pull-right">
                            <ol class="hbreadcrumb breadcrumb">
                                ...
                                <li class="active">
                                    <span>ER1 Calculation </span>
                                </li>
                            </ol>
                        </div>
                        <h2 class="font-light m-b-xs">ER1 Calculation Report
                        </h2>
