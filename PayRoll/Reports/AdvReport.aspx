<%@ Page Title="Advance Report" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdvReport.aspx.cs" Inherits="PayRoll.Reports.AdvReport" %>
            ...
            <div class="small-header">
                <div class="hpanel">
                    <div class="panel-body">
                        ...
                        <h2 class="font-light m-b-xs">Advance Report
                        </h2>
                    </div>
                </div>
            </div>
                        ...
                        <div class="panel-body">
                            <div class="col-lg-12">
                                <div class="form-group col-lg-2">
                                    ...
                                    <asp:DropDownList ID="ddlMon" runat="server" class="form-control" name="account" CausesValidation="false" TabIndex="1">
                                ...
                                <div class="form-group col-lg-2">
                                    ...
                                    <asp:DropDownList ID="ddlYear" runat="server" class="form-control" name="account" CausesValidation="false" TabIndex="2">
                                    </asp:DropDownList>
                                ...
                                <div class="form-group col-lg-2">
                                    <label for="username">Pay Status</label>
                                    <asp:DropDownList ID="ddlPayStatus" runat="server" class="form-control" name="account" TabIndex="6">
                                        <asp:ListItem Text="All" Value="" Selected="True"></asp:ListItem>
                                        <asp:ListItem Text="Paid" Value="Y"></asp:ListItem>
                                        <asp:ListItem Text="Not Paid" Value="N"></asp:ListItem>
