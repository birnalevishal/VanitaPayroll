<%@ Page Title="Bank Transfer List" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BankTransferList.aspx.cs" Inherits="PayRoll.Reports.BankTransferList" %>
                    ...
                    <div class="panel-body">
                        <div id="hbreadcrumb" class="pull-right">
                            <ol class="hbreadcrumb breadcrumb">
                                ...
                                <li class="active">
                                    <span>Bank Transfer List </span>
                                </li>
                            </ol>
                        </div>
                        <h2 class="font-light m-b-xs">Bank Transfer List
                        </h2>
                    </div>
                </div>
            </div>
                        ...
                        <div class="panel-body">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group col-lg-2">
                                    ...
                                    <asp:TextBox ID="txtChequeNo" runat="server" MaxLength="20" placeholder="" class="form-control" name="name" CausesValidation="True" ValidationGroup="OK" TabIndex="3"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RFVtxtChequeNo" runat="server" ControlToValidate="txtChequeNo" ErrorMessage="Enter Cheque No" Display="Dynamic" ForeColor="Red" ValidationGroup="OK"></asp:RequiredFieldValidator>
                                </div>
                                <div class="form-group col-lg-2">
                                    <label for="username">Transaction Date</label>
                                    <asp:TextBox ID="txtDate" runat="server" type="textarea" MaxLength="80" placeholder="Enter Date" class="form-control" name="name" CausesValidation="True" ValidationGroup="OK" TabIndex="4"></asp:TextBox>
                                ...
                                <div class="form-group col-lg-1">
                                    <label for="tt"></label>
                                    <asp:Button ID="btnShow" runat="server" Text="Show" class="btn btn-outline btn-success" ValidationGroup="OK" TabIndex="5" OnClick="btnShow_Click" />
                                </div>
                                <div class="form-group col-lg-1">
                                    <label for="tt"></label>
                            ...
                            <div class="col-lg-12">
                                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" class="table table-bordered table-striped" Height="500px"></rsweb:ReportViewer>
                            </div>
                        </div>
                    </div>
                </div>
