...
{
    public partial class SalaryIncrStatus : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataSet1TableAdapters.udf_LastSalaryIncrement1TableAdapter dt = new DataSet1TableAdapters.udf_LastSalaryIncrement1TableAdapter();
                DataSet1.udf_LastSalaryIncrement1DataTable dt1 = new DataSet1.udf_LastSalaryIncrement1DataTable();
                ...
                if (chkAll.Checked)
                {
                    ...
                    {
                        DataSet1.udf_LastSalaryIncrement1DataTable temp = new DataSet1.udf_LastSalaryIncrement1DataTable();
                ...
                ReportDataSource datasource = new ReportDataSource("SalaryIncrement", dv.ToTable());
                ReportViewer1.LocalReport.DataSources.Add(datasource);
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/SalaryIncrStatus.rdlc");
