            ...
            <div class="small-header">
                <div class="hpanel">
                    <div class="panel-body">
                        ...
                        <h2 class="font-light m-b-xs">Salary Slip Report
                        </h2>
                            ...
                            <div class="panel-body">
                                <div class="form-horizontal">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group" id="divFilter" runat="server">
                                            ...
                                            <div class="col-sm-2">
                                                <asp:DropDownList ID="ddlDesignation" runat="server" class="form-control m-b" name="account" CausesValidation="True" TabIndex="7"></asp:DropDownList>
                                            </div>
                                            ...
                                            <div class="col-sm-2">
                                                <asp:DropDownList ID="ddlCategory" runat="server" class="form-control m-b" name="account" CausesValidation="True" TabIndex="9"></asp:DropDownList>
                                            </div>
                                            <label class="col-sm-1 control-label">HOD</label>
                                            <div class="col-sm-3">
                                    ...
                                    <div class="col-lg-12">
                                        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" class="table table-bordered table-striped" Height="1000px">
                                        </rsweb:ReportViewer>
                                    </div>

                                    <div class="col-lg-12" style="display: none">
                                        <rsweb:ReportViewer ID="ReportViewer2" runat="server" Width="100%" class="table table-bordered table-striped" Height="600px">
                                        </rsweb:ReportViewer>
                                    </div>
