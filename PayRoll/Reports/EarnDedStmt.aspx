<%@ Page Title="Earning & Deduction Statement" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EarnDedStmt.aspx.cs" Inherits="PayRoll.Reports.EarnDedStmt" %>
                    ...
                    <div class="panel-body">
                        <div id="hbreadcrumb" class="pull-right">
                            <ol class="hbreadcrumb breadcrumb">
                                ...
                                <li class="active">
                                    <span>Earn. Ded. Statement </span>
                                </li>
                            </ol>
                        </div>
                        <h2 class="font-light m-b-xs">Earning & Deduction Statement Report
                        </h2>
                    ...
                    <div class="col-lg-12">
                        <div class="hpanel hblue">
                            <div class="panel-heading hbuilt">
                                ...
                                Earning & Deduction Statement Report
                            </div>
