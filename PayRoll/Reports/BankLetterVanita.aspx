<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BankLetterVanita.aspx.cs" Inherits="PayRoll.Reports.BankLetterVanita" %>
                    ...
                    <div class="panel-body">
                        <div id="hbreadcrumb" class="pull-right">
                            <ol class="hbreadcrumb breadcrumb">
                                ...
                                <li class="active">
                                    <span>Bank Letter for Vanita </span>
                                </li>
                            </ol>
                        </div>
                        <h2 class="font-light m-b-xs">Bank Letter Report for Vanita
                        </h2>
                    </div>
                </div>
            </div>
                        ...
                        <div class="panel-body">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group col-lg-4">
                                    ...
                                    <asp:DropDownList ID="ddlBankName" runat="server" class="form-control" name="account" CausesValidation="True" TabIndex="3" AutoPostBack="True" OnSelectedIndexChanged="ddlBankName_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </div>
                                <div class="form-group col-lg-2">
                                    <label for="username">Branch Name</label>
                                    <asp:DropDownList ID="ddlBranchName" runat="server" class="form-control" name="account" CausesValidation="True" TabIndex="4">
                                    </asp:DropDownList>
                                </div>
