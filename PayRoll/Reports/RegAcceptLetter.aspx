<%@ Page Title="Resignation Acceptance Letter" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegAcceptLetter.aspx.cs" Inherits="PayRoll.Reports.RegAcceptLetter" %>
                    ...
                    <div class="panel-body">
                        <div id="hbreadcrumb" class="pull-right">
                            <ol class="hbreadcrumb breadcrumb">
                                ...
                                <li class="active">
                                    <span>Resignation Acceptance Letter </span>
                                </li>
                            </ol>
                        </div>
                        <h2 class="font-light m-b-xs">Resignation Acceptance Letter
                        </h2>
