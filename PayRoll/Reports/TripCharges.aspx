<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TripCharges.aspx.cs" Inherits="PayRoll.Reports.TripCharges" %>
            ...
            <div class="small-header">
                <div class="hpanel">
                    <div class="panel-body">
                        ...
                        <h2 class="font-light m-b-xs">Trip Charges
                        </h2>
                     ...
                     <div class="hpanel hblue">
                        ...
                        <div class="panel-body">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group col-lg-2">
                                     <label for="TripAmount">Trip Amount </label>
                                     <asp:TextBox ID="txtTripAmount" runat="server" type="text" placeholder="Enter Trip Amount" class="form-control" name="name" TabIndex="5"></asp:TextBox>                     
                                </div>
