                    ...
                    <div class="panel-body">
                        <div id="hbreadcrumb" class="pull-right">
                            <ol class="hbreadcrumb breadcrumb">
                                ...
                                <li class="active">
                                    <span>ESI Register </span>
                                </li>
                            </ol>
                        </div>
                        <h2 class="font-light m-b-xs">ESI Register
                        </h2>
                    </div>
                </div>
            </div>
                        ...
                        <div class="panel-body">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group col-lg-2">
                                    ...
                                    <asp:DropDownList ID="ddlregional" runat="server" class="form-control" AutoPostBack="true" TabIndex="3" OnSelectedIndexChanged="ddlregional_SelectedIndexChanged"></asp:DropDownList>
                                </div>
                                <div class="form-group col-lg-6">                                    
                                    <asp:CheckBox ID="chkAll" runat="server" Text="All Sub-Regional" AutoPostBack="true" OnCheckedChanged="chkAll_CheckedChanged"/>
                                    <asp:Panel ID="chlpanel" runat="server" Width="500px" ScrollBars="Auto">
                                    <asp:CheckBoxList ID="chklbSubReginaol" runat="server" class="form-control" TabIndex="4" Width="800px" OnSelectedIndexChanged="chklbSubReginaol_SelectedIndexChanged1" BorderStyle="None" RepeatDirection="Horizontal" ></asp:CheckBoxList>
                                   </asp:Panel>
