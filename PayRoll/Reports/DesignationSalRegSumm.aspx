<%@ Page Title="Designation Wise Salary Reg. Summary" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DesignationSalRegSumm.aspx.cs" Inherits="PayRoll.Reports.DesignationSalRegSumm" %>
                    ...
                    <div class="panel-body">
                        <div id="hbreadcrumb" class="pull-right">
                            <ol class="hbreadcrumb breadcrumb">
                                ...
                                <li class="active">
                                    <span>Designation Wise Salary Reg. Summary </span>
                                </li>
                            </ol>
                        </div>
                        <h2 class="font-light m-b-xs">Designation Wise Salary Reg. Summary
                        </h2>
                ...
                <div class="row">
                    ...
                    <div class="hpanel hblue">
                        <div class="panel-heading hbuilt">
                            ...
                            Designation Wise Salary Register Summary
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group col-lg-2">
                                    ...
                                    <asp:DropDownList ID="ddlDesignation" runat="server" class="form-control" name="account" CausesValidation="True" AutoPostBack="True" TabIndex="2">
                                    </asp:DropDownList>
                                </div>
                            </div>
