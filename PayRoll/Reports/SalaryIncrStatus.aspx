<%@ Page Title="Salary Increment Status Report" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SalaryIncrStatus.aspx.cs" Inherits="PayRoll.Reports.SalaryIncrStatus" %>
                    ...
                    <div class="panel-body">
                        <div id="hbreadcrumb" class="pull-right">
                            <ol class="hbreadcrumb breadcrumb">
                                ...
                                <li class="active">
                                    <span>Salary Increment Status </span>
                                </li>
                            </ol>
                        </div>
                        <h2 class="font-light m-b-xs">Salary Increment Status Report
                        </h2>
                ...
                <div class="row">
                     ...
                     <div class="hpanel hblue">
                        <div class="panel-heading hbuilt">
                            ...
                            Salary Increment Status Report
                        </div>
