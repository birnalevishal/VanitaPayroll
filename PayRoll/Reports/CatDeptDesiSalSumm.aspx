<%@ Page Title="Category/Department/Designation Wise Salary Reg. Summary" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CatDeptDesiSalSumm.aspx.cs" Inherits="PayRoll.Reports.CatDeptDesiSalSumm" %>
                    ...
                    <div class="panel-body">
                        <div id="hbreadcrumb" class="pull-right">
                            <ol class="hbreadcrumb breadcrumb">
                                ...
                                <li class="active">
                                    <span>Category/Department/Designation Wise Salary Reg. Summary </span>
                                </li>
                            </ol>
                        </div>
                        <h2 class="font-light m-b-xs">Category/Department/Designation Wise Salary Reg. Summary
                        </h2>
            ...
            <div class="content">
                <div class="row">
                     ...
                     <div class="hpanel hblue">
                            ...
                            Category/Department/Designation Wise Salary Register Summary
                        </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="form-group col-lg-2">
                                 ...
                                 <div class="col-lg-3" id="divESIRadio">
                                    ...
                                    <asp:RadioButtonList ID="rblType" runat="server" RepeatDirection="Horizontal" TabIndex="3" AutoPostBack="True" OnSelectedIndexChanged="rblType_SelectedIndexChanged" AppendDataBoundItems="True">
                                ...
                                <%--  class="i-checks"--%>
                                <div class="form-group col-lg-2">
                                   <asp:Label ID="lblType" runat="server" Text="Category" Font-Bold="true"></asp:Label>
                                    <asp:DropDownList ID="ddlCategory" runat="server" class="form-control" name="account" CausesValidation="True" TabIndex="4">
                                    </asp:DropDownList>
                                </div>
                            </div>
