<%@ Page Title="Bank List" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BankList.aspx.cs" Inherits="PayRoll.Reports.BankList" %>
            ...
            <div class="small-header">
                <div class="hpanel">
                    <div class="panel-body">
                        ...
                        <h2 class="font-light m-b-xs">Bank List Report
                        </h2>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="form-group col-lg-4">
                                    ...
                                    <asp:DropDownList ID="ddlBankName" runat="server" class="form-control" name="account" CausesValidation="True" TabIndex="3">
                                    </asp:DropDownList>
                                </div>
                                <div class="form-group col-lg-4">
                                    <label for="username">Designation</label>
                                    <asp:DropDownList ID="ddlDesignation" runat="server" class="form-control" name="account" CausesValidation="True" TabIndex="3">
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="col-lg-12">
