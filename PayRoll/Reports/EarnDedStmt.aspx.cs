...
{
    public partial class EarnDedStmt : System.Web.UI.Page
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ReportDS.udf_EarnDedStatementDataTable objdt = new ReportDS.udf_EarnDedStatementDataTable();
                ReportDSTableAdapters.udf_EarnDedStatementTableAdapter obj = new ReportDSTableAdapters.udf_EarnDedStatementTableAdapter();
                ...
                ReportDataSource datasource = new ReportDataSource("EarnDeduction", dv.ToTable());
                ReportViewer1.LocalReport.DataSources.Add(datasource);
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/EarningDeductionStatementSummNew.rdlc");
                ...
                ReportParameter p3 = new ReportParameter("AddHead1", AddHead1 );
                ReportParameter p4 = new ReportParameter("AddHead2", AddHead2);
                ReportParameter p5 = new ReportParameter("AddHead3", AddHead3);
                ...
                ReportParameter p6 = new ReportParameter("LogoPath", path, true);
                ReportViewer1.LocalReport.SetParameters(new ReportParameter[] { p, p1, p2,p3,p4,p5,p6 });
