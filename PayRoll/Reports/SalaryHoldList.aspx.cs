...
{
    public partial class SalaryHoldList : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dsRegister.SalaryHoldDataTable dt1 = new dsRegister.SalaryHoldDataTable();

                dsRegisterTableAdapters.SalaryHoldTableAdapter dt = new dsRegisterTableAdapters.SalaryHoldTableAdapter();
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/rptSalaryHold.rdlc");
